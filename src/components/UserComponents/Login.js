...
const Login = () => {
	...
	return (
		<div className="flex justify-center md:items-center gap-10 h-screen p-5 ">
				...
				<form className="flex flex-col gap-8 ">
					<div className="">
						...
						<input
							...
							className="bg-gray-50 border border-gray-300  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 text-white dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
					...
					<div className="flex  gap-5 self-center items-center">
						<button
							className="text-white md:w-[5vw] text-xl bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg   sm:w-auto py-2  px-5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
							onClick={userLogin}>
							{isLoading
								? <svg
									aria-hidden="true"
									role="status"
									class="inline  w-6 h-8 mx-4 text-white animate-spin"
									viewBox="0 0 100 101"
									fill="none"
						...
						<button
							...
							{isLoading
								? <svg
									aria-hidden="true"
									role="status"
									class="inline  w-6 h-8 mx-12 text-white animate-spin"
									viewBox="0 0 100 101"
									fill="none"
									xmlns="http://www.w3.org/2000/svg">
									<path
