...
const SearchBar = ({ search, setSearch, style, focus = false }) => {
    ...
    return (
        <div className='relative'>
            <input type="text" value={search} className={`bg-gray-200 ${style} py-2 px-10  rounded-full`} placeholder='Search Friends and faimly' onChange={(e) => setSearch(e.target.value)} autoFocus={focus} />
