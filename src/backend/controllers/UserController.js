...
export const followUserHandler = function (schema, request) {
  ...
  try {
    ...
    return new Response(
      200,
      {},
      { user: updatedUser, followUser: updatedFollowUser, message: `You start following ${followUser.fullName}` }
    );
  } catch (error) {
    return new Response(
      500,
...
export const unfollowUserHandler = function (schema, request) {
  ...
  try {
    ...
    return new Response(
      200,
      {},
      { user: updatedUser, followUser: updatedFollowUser, message: `You Unfollowed ${followUser.fullName}` }
    );
  } catch (error) {
    return new Response(
      500,
